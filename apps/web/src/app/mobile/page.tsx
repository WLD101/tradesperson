...
const mobileCards = [
  ...
  { title: "Navigation", body: "Map and travel patterns belong close to the schedule and site." },
  ...
  { title: "Voice notes", body: "Reduce friction for field updates and handovers." },
