  ...
  return (
    <main className="min-h-screen bg-[#eef3f0] px-6 py-10 text-slate-950 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <Link className="text-sm font-bold text-emerald-800" href="/">Back to website</Link>
        <section className="mt-6 rounded-[2rem] bg-slate-950 p-8 text-white shadow-stitch-overlay">
          ...
          <h1 className="mt-3 max-w-4xl text-5xl font-black tracking-[-0.05em]">
            Start your Tradesperson Network workspace setup before signing in.
          </h1>
          <p className="mt-5 max-w-2xl text-slate-300">
            Tell us about your trade business, choose a commercial path, then continue through the secure onboarding flow.
            The route stays universal across the wider trades sector while keeping rollout and billing discussions structured.
          </p>
        </section>
